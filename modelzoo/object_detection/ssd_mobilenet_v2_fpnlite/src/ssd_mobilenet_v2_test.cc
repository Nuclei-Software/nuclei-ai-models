...
void setup() {
  ...
  yolov8n::model = tflite::GetModel(___pretrained_models_coco_2017_person_ssd_mobilenet_v2_fpnlite_035_224_ssd_mobilenet_v2_fpnlite_035_224_int8_tflite);
  ...
  if (op_resolver.AddResizeBilinear() != kTfLiteOk) {
    printf("Add ResizeBilinear fail!\n");
    return;
  }
