...
## Model List
 ...
 ------------------------------------------------ | ------------ | -------- | ---------------- | -------- | -------- | ---------- | ------- | ------- | --------- | --------- | ------------- 
 [Deep AutoEncoder](./deep-autoencoder/README.md) | AutoEncoder  | custom   | ToyADMOS         | 0.88     | 0.84     | (1, 640)   | 0.528 M | 267 928 | 1043 KB   | 271 KB    |               
...
3. https://github.com/NXP/eiq-model-zoo/tree/main/tasks/audio/anomaly-detection
