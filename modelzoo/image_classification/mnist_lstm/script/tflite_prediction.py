...
# =============================================================================
'''
https://github.com/tensorflow/tflite-micro/blob/main/tensorflow/lite/micro/examples/mnist_lstm/evaluate.py
'''
...
flags.DEFINE_string("model_path", "../pretrained_models/trained_lstm_int8.tflite",
                    "the trained model path.")
flags.DEFINE_string("img_path", "../../../../public_dataset/quant_img_mnist/0.bmp",
...
def main(_):
  ...
  category_probabilities = predict_image(interpreter, FLAGS.img_path)
